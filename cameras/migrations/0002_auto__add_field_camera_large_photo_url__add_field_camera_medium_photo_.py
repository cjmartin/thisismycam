...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Camera.large_photo_url'
        db.add_column('cameras_camera', 'large_photo_url', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Camera.medium_photo_url'
        db.add_column('cameras_camera', 'medium_photo_url', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Camera.small_photo_url'
        db.add_column('cameras_camera', 'small_photo_url', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Camera.large_photo_url'
        db.delete_column('cameras_camera', 'large_photo_url')

        # Deleting field 'Camera.medium_photo_url'
        db.delete_column('cameras_camera', 'medium_photo_url')

        # Deleting field 'Camera.small_photo_url'
        db.delete_column('cameras_camera', 'small_photo_url')
