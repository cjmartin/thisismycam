...
class Camera(models.Model):
    ...
    large_photo_width = models.IntegerField(default=0)
    large_photo_height = models.IntegerField(default=0)
    medium_photo_url = models.CharField(max_length=255, null=True, blank=True)
    medium_photo_width = models.IntegerField(default=0)
    medium_photo_height = models.IntegerField(default=0)
    small_photo_url = models.CharField(max_length=255, null=True, blank=True)
    small_photo_width = models.IntegerField(default=0)
    small_photo_height = models.IntegerField(default=0)
