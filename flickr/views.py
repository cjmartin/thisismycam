...
def user(request, user_slug):
    ...
    if user_cameras and flickr_user.initial_fetch_completed:
    ...
    data['contacts'] = load_cameras_for_contacts(flickr_user.contacts.filter(count_cameras__gt=0, initial_fetch_completed=True), 8)
