...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FlickrPlace.timezone'
        db.alter_column('flickr_flickrplace', 'timezone', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))


    def backwards(self, orm):
        
        # Changing field 'FlickrPlace.timezone'
        db.alter_column('flickr_flickrplace', 'timezone', self.gf('django.db.models.fields.CharField')(default=0, max_length=255))
