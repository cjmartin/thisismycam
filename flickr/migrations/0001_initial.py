...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('flickr_flickrusercamera', (
            ...
            ('date_first_taken', self.gf('django.db.models.fields.DateTimeField')()),
            ('date_last_taken', self.gf('django.db.models.fields.DateTimeField')()),
            ('date_first_upload', self.gf('django.db.models.fields.DateTimeField')()),
            ('date_last_upload', self.gf('django.db.models.fields.DateTimeField')()),
            ('first_taken_id', self.gf('django.db.models.fields.BigIntegerField')()),
            ('last_taken_id', self.gf('django.db.models.fields.BigIntegerField')()),
            ('first_upload_id', self.gf('django.db.models.fields.BigIntegerField')()),
            ('last_upload_id', self.gf('django.db.models.fields.BigIntegerField')()),
