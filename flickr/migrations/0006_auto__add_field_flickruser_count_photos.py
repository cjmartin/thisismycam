...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FlickrUser.count_photos'
        db.add_column('flickr_flickruser', 'count_photos',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FlickrUser.count_photos'
        db.delete_column('flickr_flickruser', 'count_photos')
